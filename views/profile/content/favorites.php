<!-- favorites -->
<div class="catalog-content catalog-favorites nunito">
    <?php if (!empty($favorites)) { ?>
        ...
        <div class="profile-catalog-filters">
            ...
            <div class="profile-catalog-sorting-filter">
                <div class="gray-text bold"><?= t('sorting') ?>:</div>
                <div data-inner-hide='1' data-inner-hide-add-text='1' data-inner-hide-add-text-class='profile-catalog-sorting-item' data-inner-hide-elem-class='profile-catalog-sorting-item' data-click='0' data-rotate='.arrow-icon' data-hidden='sorting-list-hidden' data-content='#catalog_sorting_items' class='profile-catalog-sorting-items underline pointer hover dropbox-toogle flex gap-50'>
