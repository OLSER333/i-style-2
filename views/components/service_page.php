        ...
        <div class="service-footer-container">
            <div class="service-footer">
                ...
                <div class="service-footer-right">
                    <a href="<?= $service_url ?>#check_in" class="service-registration-js button primary-button big-button icon-button"><?= t('sign_up_for_a_service') ?><img src="/themes/purple/assets/images/pen.svg" alt=""></a>
