...
<form method="post" class="auth-form m-auto">
    ...
    <div class="social-auth nunito text-center">
        ...
        <div class="flex flex-center social-auth-items gap-10">
            <a href='?google' class="social-auth-item hover auth-item-google-icon">
                <img src="/themes/purple/assets/images/google-icon.svg" alt="">
                <div class="social-auth-item-text-google">Войти через Google</div>
            </a>
            <a href='?facebook' class="social-auth-item hover auth-item-facebook-icon">
                <img src="/themes/purple/assets/images/facebook-icon.svg" alt="">
                <div class="social-auth-item-text">Войти через Facebook</div>
            </a>
            <a href='?twitter' class="social-auth-item hover auth-item-twitter-icon">
                <img src="/themes/purple/assets/images/twitter-icon.svg" alt="">
                <div class="social-auth-item-text">Войти через Twitter</div>
            </a>
        </div>
    ...
    <?php } ?>
    <div class="space20"></div>
    <div class="flex gap-10 user-information-login">
