$(document).ready(function () {
    ...
    $(document).on('click', '.close-service-dropbox', function (e) {
        e.preventDefault();
        let hiddenClass = $(this).attr('data-hidden');
        let elem = $(this).attr('data-content');
        $(elem).removeClass(hiddenClass);
    ...
    $(document).on('click', '.completed-registration-service', function (e) {
        e.preventDefault();
        let hiddenClass = $(this).attr('data-hidden');
        let elemCompleted = $(this).attr('data-competed');
        let dataService = $(this).attr('data-service');
        $(dataService).addClass(hiddenClass);
        $(elemCompleted).removeClass(hiddenClass);
    });

    $(document).on('click', '.close-service-complete-dropbox', function (e) {
        e.preventDefault();
        ...
        setTimeout(() => {
            $(elemCompleted).addClass(hiddenClass);
            $(dataService).removeClass(hiddenClass);
        }, 500)
    });
...
{
    let query = document.querySelectorAll('.' + openButtonClass);
